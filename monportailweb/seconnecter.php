  ...
  <div class="connection-center">
    <div class="container-connection">
      <div class="presentation">
        <img src="../images/logoFinalCS.jpg" alt="logo du club scientifique" class="jello animated">
      </div>
      <div class="connection fadeIn animated">
        ...
        <div class="form-signin" data-example-id="basic-forms">
          <form enctype="multipart/form-data" action="../control/seconnecter.php" method="post">
            ...
            <div class="insc">
              <span>Toujours pas de compte ? <a href="ouvrircompte.php" id="insc" class="btn btn-green">Inscrivez-vous</a></span>
            </div>
          ...
          <div class="checkbox">
            ...
            if (isset($_GET['erreur'])) {
              ...
              <strong id="notifications">Attention!</strong> ' . $error_conx . '</div>';
            }
            ?>
            <!-- </label> -->
          </div>

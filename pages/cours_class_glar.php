...
<div class="bodySection">
  ...
  <h1 id="thumbnails" class="titreSection">Documentation avec vidéo <i class="fas fa-sort-down fa-3x icon-right"></i></h1>
  <div class="videoList">
    <?php
      ...
      if (($video->FORMAT) == 'video') {
        ...
        <div class="videoElt">
          ...
          <div class="caption">
            ...
            <div><a href="donnees/videos/<?= $video->CONTENUDOC ?>#lecture" target="lecture" class="btn btn-primary" role="button">Regarder</a> <a href="donnees/videos/<?= $video->CONTENUDOC ?>" download="<?= $video->CONTENUDOC ?>" class="btn btn-default" role="button">Télécharger</a></div>
          </div>
        </div>
        <!-- </div> -->

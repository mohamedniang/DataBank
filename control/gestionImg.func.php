<?php
  global $conx;
    ...
    $req = $conx->query("SELECT * FROM documentations WHERE documentations.`FORMAT` = 'img'");
    $tab = array();
if($req)
...
if (isset($_POST['submit'])) {
  if (empty($_POST['CODEDOC']) && empty($_POST['TITRE'])) {
      $notifications = "Pour voir le code référence placez le curseur sur le boutton modifier.";
      $class = "alert-warning";
  }else{
